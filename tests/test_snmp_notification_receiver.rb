...
class TestSnmpNotificationReceiver < CiscoTestCase
  ...
  def test_create_destroy_single
    ...
    if platform == :nexus
      ...
      receiver = \
       Cisco::SnmpNotificationReceiver.new(id,
                                           ...
                                           security:    'priv',
                                           username:    'ab',
                                           port:        '45') # rubocop:disable Metrics/LineLength
    end
    ...
    assert_equal('red', Cisco::SnmpNotificationReceiver.receivers[id].vrf) if platform == :nexus # rubocop:disable Metrics/LineLength
  ...
  def test_create_destroy_multiple
    ...
    if platform == :nexus
      ...
      receiver2 = \
        Cisco::SnmpNotificationReceiver.new(id2,
                                            ...
                                            security:    'auth',
                                            username:    'cd',
                                            port:        '46') # rubocop:disable Metrics/LineLength
    end
    ...
    assert_equal(interfaces[1].downcase,
                 Cisco::SnmpNotificationReceiver.receivers[id2].source_interface) if platform == :nexus # rubocop:disable Metrics/LineLength
    ...
    assert_equal('red', Cisco::SnmpNotificationReceiver.receivers[id2].vrf) if platform == :nexus # rubocop:disable Metrics/LineLength
    assert_equal('auth',
